        ...
        <div class="row">
            <div class="col-lg-6">
                <div id="productCarousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item border-1">
                            <img src="{{ asset('storage/images/' . $image) }}" class="d-block w-100" alt="variant" />
                        </div>
                        @endif
                        @endforeach
                    </div>
                ...
                <div id="thumbnailCarousel">
                    ...
                    <div class="thumbnailClass mt-3">
                        <div class="product-slider swiper">
                            <div class="swiper-wrapper align-items-center">
                                @foreach ($images as $image)
                                @if ($image != '')
                                <div class="swiper-slide thumbnail" data-target="#productCarousel" data-slide-to="0">
                                    <img src="{{ asset('storage/images/' . $image) }}" class="img-fluid" alt="" />
                                </div>
                                @endif
                                @endforeach
                            </div>
                    ...
                    <div class="_p-price-box">
                        <div class="p-list mb-4 pb-2">
                            <strong>
                                ...
                                <span class="price" id="price">
                                    {{ $product->variant->count() > 1 ? Config::get('app.currency_code') .
                        ...
                        <form action="{{ route('checkout') }}" method="get" id="product-form">
                            ...
                            <div class="_p-qty-and-cart mt-4 d-flex">
                                ...
                                <button class="btn btn-buy" @if($product->variant->count() != 1) disabled @endif
                                    tabindex="0">
                                ...
                                <div class="mx-5">
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            name="name" id="exampleFormControlInput1" placeholder="name@example.com">
                                        @error('name')
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="contact" class="form-control @error('phone') is-invalid @enderror"
                                            name="phone" id="exampleFormControlInput1" placeholder="name@example.com">
                                        @error('phone')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                <a href="#">
                                    ...
                                    <p><span>{{ $product->variant->count() > 1 ? Config::get('app.currency_code') .
                                            $product->variant->min('sales_price') . ' - ' .
                                            Config::get('app.currency_code') . $product->variant->max('sales_price') :
                                            Config::get('app.currency_code') . $product->variant->min('sales_price')
                                            }}</span>
                            ...
                            <a href="{{ route('view-item', $suggestion->product_id) }}" class="stretched-link"></a>
                        </div>
                    </div>
                    @endforeach
                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                <a href="#">
                                    ...
                                    <p><span>{{ $item->product->variant->count() > 1 ? Config::get('app.currency_code')
                                            . $item->product->variant->min('sales_price') . ' - ' .
                                            Config::get('app.currency_code') .
                                            $item->product->variant->max('sales_price') :
                                            Config::get('app.currency_code') .
                                            $item->product->variant->min('sales_price') }}</span>
                                    </p>
                                </a>
                            </div>
                        </div>
