  ...
  <div class="container" data-aos="fade-up">
    <div class="row mt-4">
      <div class="col-lg-12">
        <div class="sort mb-1 mb-0">
          <div class="row justify-content-between mb-0 pb-0">
            ...
            <div class="col-md-4 col-sm-4 text-center">
              <h3>Total <span id="productCount">1</span></h3>
            </div>
            <div class="col-md-4 col-sm-4">
              <a href="#" class="greenBtn" style="color: #fff !important; float:right;">ADD ALL TO CART</a>
            </div>
          </div>
          <hr />
        ...
        <p><b>You haven't saved any items to your cart yet. Start shopping and add your favorite items to your cart.</b></p>
      </div>
      </div>
    </div>
    <div class="row mt-4">
        ...
        <div class="card mt-3">
          <div class="row justify-content-center align-items-center">
            ...
            <div class="col-7 text-contet">
              ...
              <h4><a href="{{ route('view-item', $item->product->product_id) }}"><span style="color: black">{{ $item->product->title }}</span></a>
              </h4>
              <p>
              ...
              <p class="buttonChange" style="font-size: 18px">
                ...
                <span class="amount" id="cart-qty{{ $item->cart_id }}" data-total="{{ $price * $item->qty }}" data-amount="{{ $price }}">{{ $item->qty }}</span>
      ...
      <div class="col-lg-6">
        <div class="form-section mt-3">
          ...
          <form action="{{ route('apply-coupon') }}" method="POST">
            ...
            <div class="row align-items-center justify-content-center">
              <div class="col-lg-7">
                <input type="text" id="couponCode" class="@error('couponCode') is-invalid @enderror" name="couponCode" placeholder="Coupon code" /><br />
                @error('couponCode')
        ...
        <div class="form-section mt-3">
          ...
          <p class="d-flex justify-content-between">
            <span>Sub total</span> <span id="subTotal">{{ Config::get('app.currency_code') . number_format($subTotal, 2) }}</span>
          </p>
          <p class="d-flex justify-content-between">
        ...
        <div class="btn-section mt-3 text-center">
          <button onclick="window.location.href='{{ route('checkout') }}'" class="green" type="button" {{-- data-bs-toggle="modal"
  ...
  function submitData(method) {
    $.ajax({
      ...
      success: function(data) {
        let coupon = {
          {
            session() - > has('coupon') ? $couponAmount : 0
          }
        };
        if (data.remove) {
        ...
        $('#subTotal').text('{{ Config::get('
          app.currency_code ') }}' + (data.total_price).toFixed(2));
        $('#total').text('{{ Config::get('
          app.currency_code ') }}' + (data.total_price - coupon).toFixed(2));
      }
    })
  }
</script>
