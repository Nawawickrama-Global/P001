        ...
        <div class="container">
            <div class="row content">
                ...
                <div class="col-lg-4 mt-4">
                    ...
                    background-image: url(assets/img/category/category-1.jpg);
                  ">
                        <div class="content">
                            <h4>FUrniture</h4>
                ...
                <div class="col-lg-4 mt-4">
                    <div class="card" style="
                    background-image: url(assets/img/category/category-2.jpg);
                  ">
                        <div class="content">
                            <h4>FUrniture</h4>
                            <a href="">discover more</a>
                ...
                <div class="col-lg-4 mt-4">
                    <div class="card" style="
                    background-image: url(assets/img/category/category-3.jpg);
                  ">
                        <div class="content">
                            <h4>FUrniture</h4>
                            <a href="">discover more</a>
                ...
                <div class="col-lg-4 mt-4">
                    <div class="card" style="
                    background-image: url(assets/img/category/category-4.jpg);
                  ">
                        <div class="content">
                            <h4>FUrniture</h4>
                            <a href="">discover more</a>
                ...
                <div class="col-lg-4 mt-4">
                    <div class="card" style="
                    background-image: url(assets/img/category/category-5.jpg);
                  ">
                        <div class="content">
                            <h4>FUrniture</h4>
                            <a href="">discover more</a>
                ...
                <div class="col-lg-4 mt-4">
                    <div class="card" style="
                    background-image: url(assets/img/category/category-6.jpg);
                  ">
                        <div class="content">
                            <h4>FUrniture</h4>
                            <a href="">discover more</a>
