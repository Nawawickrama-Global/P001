                            ...
                            <tbody>
                                @foreach ($allCategories as $key => $category)
                                    <tr>
                                        ...
                                        <td>
                                            {{-- view --}}
                                            <a type="button" data-name="{{ $category->name }}"
                                                data-description="{{ $category->description }}"
                                                data-category_image="{{ URL::to('storage/images/' . $category->category_image) }}"
                                                data-status="{{ $category->status }}" class="badge badge-warning view"
                                                title="View">
                                          ...
                                          @endphp @endif
                                                ...
                                                data-description="{{ $category->description }}"
                                                data-category_image="{{ URL::to('storage/images/' . $category->category_image) }}"
                                                data-status="{{ $category->status }}" class="badge badge-success edit"
                                                title="Edit">
