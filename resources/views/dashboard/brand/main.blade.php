                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="form-group text-right">
                                    <button type="submit" id="add-btn" class="btn btn-primary mr-2 mb-2 mb-md-0 text-white">Add</button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @foreach ($brands as $key => $brand)
                                    <tr>
                                        ...
                                        <td>
                                            {{-- view --}}
                                            <a type="button" data-id="{{ $brand->brand_id }}"
                                                data-name="{{ $brand->name }}"
                                                data-description="{{ $brand->description }}"
                                                data-brand_image="{{ URL::to('storage/images/' . $brand->brand_image) }}"
                                                data-status="{{ $brand->status }}" class="badge badge-warning view"
                                                title="View">
                                                <i data-feather="eye"></i>
                                            </a>
                                            {{-- edit --}}
                                            <a type="button" data-id="{{ $brand->brand_id }}" data-name="{{ $brand->name }}"
                                              data-description="{{ $brand->description }}"
                                              data-brand_image="{{ URL::to('storage/images/' . $brand->brand_image) }}"
                                              data-status="{{ $brand->status }}" class="badge badge-success edit" title="Edit">
                                            ...
                                            <form action="{{ route('delete-brand', $brand->brand_id) }}" method="post">
                                              @csrf
                                              @method('delete')
                                                <button type="submit" class="badge badge-danger delete mt-2" title="Delete">
